    ...
    <div className="fallback-diagram" role="img" aria-label={`简化分步图：${step.title}`}>
      <svg viewBox="0 0 620 480" aria-hidden="true">
        ...
        <g fill="none" strokeLinecap="round" strokeWidth="13">
          <path d="M48 354C85 342 118 344 143 355" stroke="#b58b62" />
          <ellipse cx="164" cy="354" rx="53" ry="33" stroke="#ff7257" strokeDasharray="280" strokeDashoffset={280 * (1 - progress)} />
          <path d="M196 358c42-22 77-14 96 12" stroke="#ff7257" opacity={progress > 0.52 ? 1 : 0.18} />
        </g>
